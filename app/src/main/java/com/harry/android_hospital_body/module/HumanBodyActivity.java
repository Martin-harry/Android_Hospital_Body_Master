package com.harry.android_hospital_body.module;
...
import com.harry.android_hospital_body.R;
import com.harry.android_hospital_body.widget.HumanBodyPopupWindow;
import com.harry.android_hospital_body.widget.IosButton;
...
public class HumanBodyActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void initView() {
        ...
        // 设置人体图 （默认为男性正面）
        androidx.fragment.app.FragmentTransaction fm = getSupportFragmentManager().beginTransaction();
